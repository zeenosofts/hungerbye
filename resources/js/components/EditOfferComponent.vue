<template >
    <div>
        <section class="content-header">
            <h1>
                Dashboard
                <small>Offers > Edit Offers</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-4">
                <div class="box box-primary">
                    ...
                    <div class="box-footer clearfix no-border">
                        <button type="button" class="btn btn-primary btn-flat pull-right" @click="updateItem()"><i class="fa fa-plus"></i> Update Offer</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            getItemForthis(){
                let self=this;
                Promise.resolve(main.sendPOSTRequest('getOfferForthis',{id:self.$route.params.id})).then(function (response) {
            ...
            updateItem(){
                ...
                else if(self.item.item_price.trim().length == 0)
                {
                    ...
                    Promise.resolve(main.sendPOSTRequest('updateOffer',self.item)).then(function (response) {
                        if(response.data == "duplicate"){
                            Vue.$toast.warning("Item with this name already present");
                        }else if(response.data == "success"){
                            Vue.$toast.success("Offer updated successfully");
