                                ...
                                <datatable id="attendanceTable" :columns="columns" :data="items" class="table-bordered">
                                    ...
                                    <template slot-scope="{ row }">
                                        <tr>
                                            ...
                                            <td @click="donate(row.did)"><button @click="donate(row.did)" class="btn btn-flat btn-sm btn-success" v-if="row.status == '0'">Completed/View</button><button v-if="row.status > 0" class="btn btn-flat btn-primary btn-sm" @click="donate(row.did)">Donate</button></td>
                                        </tr>
                                    </template>
                                </datatable>
                                <div class="row">
...
<script>
    export default {
        ...
        methods: {
            ...
            getItemsForDonor() {
                let self = this;
                axios.get('get_requests_to_show').then(function (response) {
