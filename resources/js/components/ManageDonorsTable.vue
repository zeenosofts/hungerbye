<template>
    <div>
        <section class="content-header">
            <h1>
                Dashboard
                <small>Admin > Manage Donors</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-heart"></i> Admin</a></li>
                <li class="active">Manage Donors</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Manage Donor</h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getAllUsers() {
                let self = this;
                Promise.resolve(main.sendPOSTRequest('getAllDonors',{'key' :"nun"})).then(function (response) {
