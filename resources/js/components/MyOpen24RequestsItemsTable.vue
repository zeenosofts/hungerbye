<template>
    <div>
        <section class="content-header">
            <h1>
                Dashboard
                <small>Donation > Requests open over 24hrs</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-reorder"></i> Donation</a></li>
                <li class="active">Requests open over 24hrs</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Requests open over 24hrs</h3>
                                ...
                                <datatable id="attendanceTable" :columns="columns" :data="items" class="table-bordered">
                                    ...
                                    <template slot-scope="{ row }">
                                        <tr>
                                            ...
                                            <td><button class="btn btn-flat btn-success" v-if="row.status == '0'">Completed</button><button v-if="row.status > 0" class="btn btn-flat btn-primary" @click="donate(row.did)">Donate</button></td>
                                        </tr>
                                    </template>
                                </datatable>
                                <div class="row">
...
<script>
    export default {
        ...
        methods: {
            ...
            getItemsForDonor() {
                let self = this;
                axios.get('get_my_requests_to_show_open_24').then(function (response) {
