                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <multiselect v-model="item.item_name" :options="items"  placeholder="Select" label="item_name" track-by="id" ><span slot="noResult">No item found.Please add an item first by going to <b>Manage Products</b>.</span></multiselect>
