<template>
    <div>
        <section class="content-header">
            <h1>
                Dashboard
                <small>Donation > Contributed to Requests</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-reorder"></i> Donation</a></li>
                <li class="active">Contributed to Requests</li>
            </ol>
        </section>
                ...
                <div class="col-lg-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Contributed to Requests</h3>
...
<script>
    export default {
        data() {
            return {
                ...
                columns: [
                    ...
                    { label: 'Donated By Me', field: 'emp.today_date',sortable:false },
        ...
        methods: {
            ...
            getItemsForDonor() {
                let self = this;
                axios.get('get_requests_to_show_contributed').then(function (response) {
