...
/* harmony import */ var _defaults_locales__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("f15d");
...
const formatFlags = {
  ...
  DD(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.day);
  },
  ...
  dd(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.weekday - 1);
  },
  ...
  MM(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.month);
  },
  ...
  YYYY(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.year, 4);
  },
  ...
  hh(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.hours % 12 || 12);
  },
  ...
  HH(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.hours);
  },
  ...
  mm(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.minutes);
  },
  ...
  ss(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.seconds);
  },
  ...
  SS(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(Math.round(d.milliseconds / 10), 2);
  },

  SSS(d) {
    return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(d.milliseconds, 3);
  },
  ...
  X(d) {
    ...
    return `${o > 0 ? '-' : '+'}${Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(Math.floor(Math.abs(o) / 60), 2)}`;
  },

  XX(d) {
    const o = d.timezoneOffset;
    return `${o > 0 ? '-' : '+'}${Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(Math.floor(Math.abs(o) / 60) * 100 + Math.abs(o) % 60, 4)}`;
  },

  XXX(d) {
    const o = d.timezoneOffset;
    return `${o > 0 ? '-' : '+'}${Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(Math.floor(Math.abs(o) / 60), 2)}:${Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pad */ "q"])(Math.abs(o) % 60, 2)}`;
  }
...
function resolveConfig(config, locales) {
  ...
  if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isString */ "m"])(config)) {
    id = config;
  } else if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* has */ "e"])(config, 'id')) {
    id = config.id;
  }
  ...
  config = Object(___WEBPACK_IMPORTED_MODULE_3__[/* isObject */ "l"])(config) ? Object(___WEBPACK_IMPORTED_MODULE_3__[/* defaultsDeep */ "c"])(config, defLocale) : defLocale; // Return resolved config

  return config;
}
class Locale {
  constructor(config, locales = _defaults_locales__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"]) {
    const {
      id,
      firstDayOfWeek,
      masks
    ...
    this.id = id;
    this.firstDayOfWeek = Object(___WEBPACK_IMPORTED_MODULE_3__[/* clamp */ "a"])(firstDayOfWeek, 1, daysInWeek);
    this.masks = masks;
  ...
  format(date, mask, timezone) {
    ...
    mask = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* arrayHasItems */ "b"])(mask) && mask[0] || Object(___WEBPACK_IMPORTED_MODULE_3__[/* isString */ "m"])(mask) && mask || 'YYYY-MM-DD';
  ...
  parse(dateStr, mask, timezone) {
    ...
    const masks = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* arrayHasItems */ "b"])(mask) && mask || [Object(___WEBPACK_IMPORTED_MODULE_3__[/* isString */ "m"])(mask) && mask || 'YYYY-MM-DD'];
  ...
  normalizeDate(d, config = {}) {
    ...
    if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isNumber */ "k"])(d)) {
      type = 'number';
      result = new Date(+d);
    } else if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isString */ "m"])(d)) {
      type = 'string';
      const mask = config.mask || 'iso';
      result = d ? this.parse(d, mask, config.timezone) : null;
    } else if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isObject */ "l"])(d)) {
      type = 'object';
      result = this.getDateFromParts(d, config.timezone);
    } else {
      type = 'date';
      result = Object(___WEBPACK_IMPORTED_MODULE_3__[/* isDate */ "i"])(d) ? new Date(d.getTime()) : null;
    }
  ...
  toPage(arg, fromPage) {
    if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isNumber */ "k"])(arg)) {
      return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* addPages */ "a"])(fromPage, arg);
    }

    if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isString */ "m"])(arg)) {
      return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pageForDate */ "r"])(this.normalizeDate(arg));
    }

    if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isDate */ "i"])(arg)) {
      return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__[/* pageForDate */ "r"])(arg);
    }

    if (Object(___WEBPACK_IMPORTED_MODULE_3__[/* isObject */ "l"])(arg)) {
      return arg;
    }
